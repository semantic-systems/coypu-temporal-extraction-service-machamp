...
class WIKIWARSTAGGED(TaskFormat):
    ...
    def load_from_file(filename, language="en") -> List[Sentence]:
        ...
        with open(filename) as fin:
            for line in fin:
                ...
                instance = WIKIWARSTAGGED(sent_id=sentence_id, sentence_tokens=tokens, sentence_text=text, sentence_entities=entities,language=language
                ).generate_instance()
