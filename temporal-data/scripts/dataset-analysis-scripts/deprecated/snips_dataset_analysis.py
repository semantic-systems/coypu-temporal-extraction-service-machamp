...
class SnipsDatasetAnalyzer:
    ...
    def __init__(self, dataset_filepaths: List[str], analysis_output_path: str) -> None:
        ...
        def load_dataset(dataset_filepaths: List[str]) -> List[dict]:
            ...
            Args:
                dataset_filepath: List of filepath to the dataset files. Tested only with fullfile paths.
        ...
        for entity in entities:
            ...
            for timex3 in timex_entities:
                ...
                if timex3_type == "DURATION":
                    entity_information["duration_regex"] = self.snips_dataset_duration_span_regex_extractor(timex3["beginPoint"], timex3["endPoint"], entities)
    ...
    def snips_dataset_duration_span_regex_extractor(self, beginPoint: str, endPoint: str, entities: List[dict]) -> str:
        """
...
def main():
    ...
    snips_analysis_output_path = "/export/home/4kirsano/uie/dataset_processing/scripts/myscripts/snips_dataset_analysis_output.txt"

    snips_dataset_analyzer = SnipsDatasetAnalyzer(snips_dataset_paths, snips_analysis_output_path)
    snips_dataset_analyzer.analyze()
    snips_dataset_analyzer.generate_analysis_results()
    snips_dataset_analyzer.generate_analysis_data_entry_results()
    snips_dataset_analyzer.generate_analysis_data_entry_timex3_empty_results()
    snips_dataset_analyzer.save_analysis_results()
