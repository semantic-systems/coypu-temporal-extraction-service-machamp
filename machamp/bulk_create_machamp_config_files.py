...
if __name__ == "__main__":
    ...
    parser.add_argument('--datasets_base_dir', '-d', default='../temporal-data/entity/my_converted_datasets/bio')
    parser.add_argument('--output_dir', '-o', default='configs/temporal_configs')
    args = parser.parse_args()

    datasets_base_directory = args.datasets_base_dir
